...
public class Livro {
	...
	@NotEmpty(message = "O campo nome não pde ser vazio")
	private String nome;
	...
	@JsonInclude(Include.NON_NULL)
	@NotNull(message = "Campo editora é deve preenchimento obrigatório")
	private String editora;

	@JsonInclude(Include.NON_NULL)
	@NotEmpty(message = "O Resumo deve er preenchido")
